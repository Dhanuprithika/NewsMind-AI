...
import { ArrowLeft, Bell, Shield, HelpCircle, LogOut, ChevronRight, Bookmark, Loader2 } from 'lucide-react';
...
import { getSavedArticles, type Article } from '../services/api';
...
export function Profile() {
  const { saveUserProfile, isSaving } = useUser();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <section className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-xl font-bold">Saved Intelligence</h3>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {savedArticles.map((article, i) => (
                    <NewsCard 
                      ...
                      article={article} 
                      index={i} 
                      onReadMore={(a) => window.location.href = `/article/${a.id}`} 
                      onBookmark={() => {}} // Handle unsave if needed
                    />
                  ))}
                </div>
              ) : (
                <div className="text-center py-12 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
                  <p className="text-gray-400 font-serif lowercase italic">No saved reports found.</p>
                </div>
              )}
            </section>
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <motion.button
              ...
              disabled={isSaving}
              className="w-full py-4 bg-[#c0392b] hover:bg-[#a93226] text-white rounded-2xl transition-colors shadow-lg font-bold flex items-center justify-center gap-2 disabled:opacity-70"
            >
